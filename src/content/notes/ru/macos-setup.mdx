...
- **Accessibility:**
  - Show window title icons – OFF.
- **Lock Screen:**
  - Turn display off ... (both) – 1h.
  - Require password ... – 5 min.
...
- `brew install cmake p7zip pnpm git git-lfs killport openssh gh fzf zsh-autosuggestions zsh-syntax-highlighting`.
  - `git lfs install`
  - `brew link openssh`
  - `gh auth login`
...
- [agterm](https://agterm.com/) – the best terminal for agent management.
