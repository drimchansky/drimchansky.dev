...
- Разрабатывал приложение универсального интерфейса и бизнес-логики для игр с использованием React, Redux-toolkit, Tailwind CSS;
- Разрабатывал внутренние инструменты для оптимизации как процессов разработки, так и работы в других отделах компании;
- Запустил веб-сайт документации с использованием Docusaurus;
